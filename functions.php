...
function add_featured_image_instruction( $content ) {
    return $content .= '<p>We recommend JPEG images, with dimensions of 1024x768 (MDPI) or 1920x1080 (HD).</p>';
}

function my_acf_google_map_api( $api ){
    
    $api['key'] = 'AIzaSyCwSalBQtvNF0UyY7zUY-xIS-nkicqV05k​';
...
class My_Walker extends Walker_Nav_Menu
{
    function start_el(&$output, $item, $depth, $args) {
        ...
        $item_output .= '<a'. $attributes .' style="border-left-color:' . $item->description . '; !important">';
